import {
  ...
  const projects = [
   
    {
      ...
      image: mastercheck,
      source_code_link: "https://play.google.com/store/apps/details?id=com.ontariolimited.mastercheck",
    },
      {
        name: "Faveo helpdesk",
        description:
        ...
        image: faveo,
        source_code_link: "https://play.google.com/store/search?q=faveo%20helpdesk&c=apps",
      },
      {
        name: "Aligner 4D",
        description:
        ...
        image: aligner,
        source_code_link: "https://aligner4dadb2c.b2clogin.com/aligner4dadb2c.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_aligner4dSignInFlow&client_id=f300da0f-36c4-4b04-8e2b-74b02c17d132&nonce=defaultNonce&redirect_uri=https://www.corporate-aligner.rootquotient.com/auth&scope=openid&response_type=code&prompt=login",
      },
      {
        name: "SkyBell",
        description:
